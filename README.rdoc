...
==== Test
(This requires rspec-rails (and thus rspec) and mocha to be available on your system.)

Run the plugin specs with: 

<tt>rake spec:plugins PLUGIN=sortable_element_for_nested_set</tt>
